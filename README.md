...
View the case study [here](https://8weeksqlchallenge.com/case-study-1/) and my **solution** [here]([link to the solution](https://github.com/navneet0501/8-Week-SQL-Challenge/blob/main/Danny's_Diner_Solution.md)).
### Business Task
...
View the case study [here](https://8weeksqlchallenge.com/case-study-2/) and my **solution** [here](link to the solution).
...
View the case study [here](https://8weeksqlchallenge.com/case-study-3/) and my **solution** [here](link to the solution).
...
View the case study [here](https://8weeksqlchallenge.com/case-study-4/) and my **solution** [here](link to the solution).
...
View the case study [here](https://8weeksqlchallenge.com/case-study-5/) and my **solution** [here](link to the solution).
...
View the case study [here](https://8weeksqlchallenge.com/case-study-6/) and my **solution** [here](link to the solution).
...
View the case study [here](https://8weeksqlchallenge.com/case-study-8/) and my **solution** [here](link to the solution) and on [Medium].
